...
public interface ApiEndpoints {
    ...
    String DEFAULT_PROPERTY_OWNER_JSON = "/json/propertyowner/default";
    String PROPERTY_OWNER_JSON = "/json/propertyowner";
    String REAL_ESTATE_JSON = "/json/realestate";
    String REAL_ESTATES_JSON = "/json/realestates";
    String REAL_ESTATE_COMPONENT_JSON = "/json/realestatecomponent";
    String REAL_ESTATE_COMPONENTS_JSON = "/json/realestatecomponents";
    String BUILDING_COMPONENT_JSON = "/json/buildingcomponent";
    String BUILDING_COMPONENTS_JSON = "/json/buildingcomponents";
    String STOREY_JSON = "/json/storey";
    String STOREYS_JSON = "/json/storeys";
    String ROOM_JSON = "/json/room";
    String ROOMS_JSON = "/json/rooms";
    String ASSET_JSON = "/json/asset";
    String ASSETS_JSON = "/json/assets";
    String DEVICE_JSON = "/json/device";
    String DEVICES_JSON = "/json/devices";
