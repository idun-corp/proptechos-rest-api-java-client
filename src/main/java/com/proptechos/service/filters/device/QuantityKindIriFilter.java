 ...
 */
public class QuantityKindIriFilter implements IQueryFilter {

    private final String quantityKinds;

    public QuantityKindIriFilter(List<String> quantityKinds) {
        this.quantityKinds = String.join(",", quantityKinds);
    }

    @Override
    public QueryParam queryParam() {
        return new QueryParam("quantity_kind_iris", quantityKinds);
    }
}
