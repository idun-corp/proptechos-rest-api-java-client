 ...
 */
public class MeasurementUnitIriFilter implements IQueryFilter {

    private final String measurementUnits;

    public MeasurementUnitIriFilter(List<String> measurementUnits) {
        this.measurementUnits = String.join(",", measurementUnits);
    }

    @Override
    public QueryParam queryParam() {
        return new QueryParam("measurement_unit_iris", measurementUnits);
    }
}
