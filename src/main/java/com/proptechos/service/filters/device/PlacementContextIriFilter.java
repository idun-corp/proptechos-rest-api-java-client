 ...
 */
public class PlacementContextIriFilter implements IQueryFilter {

    private final String placementContexts;

    public PlacementContextIriFilter(List<String> placementContexts) {
        this.placementContexts = String.join(",", placementContexts);
    }

    @Override
    public QueryParam queryParam() {
        return new QueryParam("placement_context_iris", placementContexts);
    }
}
